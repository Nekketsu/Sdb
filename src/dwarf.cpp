...
namespace
{
    ...
    sdb::call_frame_information::common_information_entry parse_cie(cursor cur)
    {
        ...
        if (version == 4)
        {
            ...
            if (segment_size != 0)
            {
                sdb::error::send("Invalida segment size");
            }
        }
    ...
    struct unwind_context
    {
        ...
        using rule = std::variant<undefined_rule, same_rule, offset_rule, val_offset_rule, register_rule>;
        ...
        unwind_context& ctx, sdb::file_addr pc)
    {
        ...
        else if (extended_opcode)
        {
            ...
            case DW_CFA_def_cfa_expression:
                sdb::error::send("DWAR expressions not yet implemented");
